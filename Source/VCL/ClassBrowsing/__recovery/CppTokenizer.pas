...
type
  ...
  private
    ...
    procedure SkipPair(cStart, cEnd: AnsiChar; FailChars: TSysCharSet = []);
...
procedure TCppTokenizer.SkipPair(cStart, cEnd: AnsiChar; FailChars: TSysCharSet); // e.g.: SkipPair('[', ']');
begin
  Inc(pCurrent);
