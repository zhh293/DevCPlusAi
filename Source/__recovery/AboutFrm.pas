...
begin
  ...
  ShellExecuteW(GetDesktopWindow(), 'open', PWideChar(S), nil, nil, SW_SHOWNORMAL);
end;
...
var
  DonateUrl: string;
begin
  DonateUrl := 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=7FD675DNV8KKJ';
  ShellExecuteW(GetDesktopWindow(), 'open',
    PWideChar(DonateUrl), nil, nil,
    SW_SHOWNORMAL);
end;
