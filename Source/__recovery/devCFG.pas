...
ComCtrls, SynEditTextBuffer, CBUtils, AgentConfig;
...
//    procedure OnCompilerSetChanged(OldSet, NewSet: TdevCompilerSet);
  ...
  published
    ...
    property CustomCommand: AnsiString read fCustomCommand write fCustomCommand;
  end;
...
var
  ...
  devAgentConfig: TdevAgentConfig = nil;
...
begin
  ...
  if not Assigned(devAgentConfig) then
    devAgentConfig := TdevAgentConfig.Create;
